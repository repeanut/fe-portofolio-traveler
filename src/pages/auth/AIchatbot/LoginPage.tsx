...
const LoginPage = () => {
    ...
    const handleSubmit = (e: FormEvent) => {
        e.preventDefault();
        // Dummy auth: anggap login selalu sukses
            ...
            <div className="relative overflow-hidden">
                ...
                <div className="relative h-full flex items-center justify-center px-6 py-14">
                    <div className="w-full max-w-md bg-white rounded-3xl shadow-[0_24px_60px_rgba(0,0,0,0.25)] px-10 py-10">
                        ...
                        <p className="mt-2 text-sm text-gray-400 text-center">Please log in to continue!</p>
                        ...
                        <div className="mt-6 text-center text-xs text-gray-500">
                            ...
                            <button type="button" onClick={handleGoToSignUp} className="ml-1 text-gray-800 underline">
                                Sign up
                            </button>
                        </div>
                    </div>
