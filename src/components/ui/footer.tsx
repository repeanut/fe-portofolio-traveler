    ...
    return (
        <footer id="contact" className="w-full bg-[#e8f3fb]">
            <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 py-12 md:py-16">
                <div className="grid gap-10 md:grid-cols-[1.4fr_3fr] items-start">
                    ...
                    <div className="space-y-5 text-center md:text-left">
                        <div>
                            ...
                            <p className="mt-2 max-w-xs mx-auto md:mx-0 text-sm text-slate-600">
                ...
                <div className="mt-10 flex flex-col gap-4 border-t border-slate-200 pt-5 text-xs text-slate-500 text-center md:text-left md:flex-row md:items-center md:justify-between">
                    <p>Rizwords © 2026-2027, All Rights Reserved</p>

                    <div className="flex flex-wrap items-center justify-center md:justify-end gap-2">
                        <img src="/icon-visa.png" alt="Visa" className="h-7 w-auto" />
                        <img src="/icon-mastercard.png" alt="Mastercard" className="h-7 w-auto" />
                        <img src="/icon-paypal.png" alt="Paypal" className="h-7 w-auto" />
                        <img src="/icon-applepay.png" alt="Apple Pay" className="h-7 w-auto" />
                        <img src="/icon-googlepay.png" alt="Google Pay" className="h-7 w-auto" />
                    </div>
                </div>
            </div>
        </footer>
