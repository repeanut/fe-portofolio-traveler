...
const DashboardRecentOrdersCard: React.FC<DashboardRecentOrdersCardProps> = ({
  ...
  return (
    <section className="flex min-w-0 flex-col rounded-2xl border border-slate-100 bg-white p-5 shadow-sm max-w-full overflow-hidden">
            ...
            {recentOrders.map((order) => {
              ...
              return (
                <div key={order.id} className="grid grid-cols-12 items-center px-4 py-3">
                  ...
                  <div className="col-span-2 text-[11px] font-medium text-slate-800 truncate">{formatRupiah(order.total)}</div>
